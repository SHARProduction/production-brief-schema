...
Indexing: the verified primary deployment is `https://production-brief-browser.bullolaya.workers.dev/`; source and dist use `index,follow` with that exact canonical. Keep any later full mirror noindex unless it becomes the selected primary. No main-site robots/canonical changes are needed.
